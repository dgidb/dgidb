class AddGeneGeneInteractionTable < ActiveRecord::Migration
  def up
    ...
    add_index :inter_gene_interaction_claims, :gene_id
    add_index :inter_gene_interaction_claims, :interacting_gene_id
    ...
    execute 'ALTER TABLE inter_gene_interaction_claims ADD CONSTRAINT fk_gene_interaction_claims_gene FOREIGN KEY (gene_id) REFERENCES genes (id) MATCH FULL'
    execute 'ALTER TABLE inter_gene_interaction_claims ADD CONSTRAINT fk_gene_interaction_claims_interacting_gene FOREIGN KEY (interacting_gene_id) REFERENCES genes (id) MATCH FULL'
    execute 'CREATE INDEX left_and_interacting_gene_interaction_index ON inter_gene_interaction_claims (gene_id, interacting_gene_id)'
  ...
  def down
    execute 'DROP TABLE inter_gene_interaction_claims CASCADE'
    execute 'DROP TABLE inter_gene_interaction_claim_attributes CASCADE'
  end
end
