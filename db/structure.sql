...
--
-- Name: index_gene_aliases_on_nomenclature; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_gene_aliases_on_nomenclature ON gene_aliases USING btree (nomenclature);
